class EmacsMacM1a < Formula
  desc "YAMAMOTO Mitsuharu's Mac port of GNU Emacs"
  homepage 'https://www.gnu.org/software/emacs/'
  url 'https://bitbucket.org/mituharu/emacs-mac/get/INVALID_URL_USE_HEAD_INSTEAD.tar.gz'
  version 'emacs-28.1-mac-9.0'
  sha256 '967d5642ca47ae3de2626f0fc7163424e36925642827e151c3906179020dd90e'

  head 'https://github.com/jasonjckn/emacs-mac.git', branch: 'master'
  ...
  def install
    ...
    if build.with? 'native-comp'
      ...
      ENV['CFLAGS'] =
        '-I/opt/homebrew/opt/llvm/include -mmacosx-version-min=12 -isysroot/Library/Developer/CommandLineTools/SDKs/MacOSX12.sdk'
